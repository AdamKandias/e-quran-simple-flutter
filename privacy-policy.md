...
For a better experience we dont have any request anything to user. All user do is download the app, and use it. We not provide register, login or etc. And this app doesn't have database and backend.
...
Contact Information:
Email: guritalangit.dev@gmail.com